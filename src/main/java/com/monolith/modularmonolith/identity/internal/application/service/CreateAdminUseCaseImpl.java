...
import com.monolith.modularmonolith.identity.internal.application.port.inbound.CreateAdminUseCase;
...
public class CreateAdminUseCaseImpl implements CreateAdminUseCase {
    ...
    @Override
    @Transactional
    public UserProfileResponse execute(AdminCreateRequest request) {
        ...
        User user = User.builder()
                ...
                .roles(new HashSet<>(request.roles() != null ? request.roles() : Set.of(Role.ADMIN)))
                .build();
        ...
        log.info("Admin created: id={}, adminId={}, email={}", saved.getId(), admin.getAdminId(), saved.getEmail());
    ...
    private String generateAdminId() {
        ...
        return String.format("ADM-%s-%05d", year, count);
    }
}